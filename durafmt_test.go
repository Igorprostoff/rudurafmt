...
func TestParseWithLimitToUnit(t *testing.T) {
	testTimesWithLimitUnit = []struct {
		...
		{87593183 * time.Second, "секунда", "87593183 секунды"},
		{87593183 * time.Second, "минуты", "1459886 минут 23 секунды"},
		{87593183 * time.Second, "часы", "24331 час 26 минут 23 секунды"},
		{87593183 * time.Second, "дни", "1013 дней 19 часов 26 минут 23 секунды"},
		{87593183 * time.Second, "недели", "144 недели 5 дней 19 часов 26 минут 23 секунды"},
		{87593183 * time.Second, "годы", "2 года 40 недель 3 дня 19 часов 26 минут 23 секунды"},
